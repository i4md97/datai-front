...
export default function MenuEvolucionSemanal({ menuInicio }) {
    ...
    return (
        <div className={`home-sidebar ${menuInicio ? "menuOn" : "menuOff"}`}>
                ...
                <div className="col-12 p-0">
                    <Card>
                        <CardBody className="py-2">
                            <Row>
                                <Col sm={12} md={6} lg={4}>
                                    <h2 className="business-title general-title pt-1">Globales</h2>
                                ...
                                <Col sm={12} md={6} lg={4}>
                                    <h2 className="business-title pt-1 general-title pb-3">Producto</h2>
                                    <Select
                                        className="global-select"
                                        isMulti
                                        onChange={(value) => {
                                    ...
                                    <h4 className="business-subtitle pb-1">Periodo</h4>
                                    <div className="container-datepicker pb-2">
                                        <DatePicker
